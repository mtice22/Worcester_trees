# Worcester_trees
Visualization of Worcester Tree Data

My group was tasked with creating a dashboard for the Worcester Tree Inititave (WTI). They had various tree metric data for Worcster 
Trees:
